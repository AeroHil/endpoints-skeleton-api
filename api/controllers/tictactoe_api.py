...
from api.api_commons import capitolbells
from api.models.models import Score
from api.messages.tictactoe_api_messages import *


@capitolbells.api_class(resource_name='tictactoe', path='tictactoe')
class TicTacToeApi(remote.Service):
    ...
    def add_move_to_board(board_state):
        ...
        Args:
            board_state: String; contains only '-', 'X', and 'O' char`acters.
